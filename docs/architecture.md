...
- Chosen: conformance corpus generation from deterministic seeds + engine response materialization to scale to 457 cases quickly.

## Known gaps
- Current upstream extraction in Conform corpus is limited to `date-fns`; requested peers were unavailable in snapshot.
